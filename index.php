...
//--------------------------------------------https://t.me/@Sourrce_kade----------------------------------
    ...
    $year_number = jdate('y');
    $day_name = jdate('l');
    if(!file_exists("join.txt")){try{$MadelineProto->channels->joinChannel(['channel' => "https://t.me/ShahreSource", ]); touch('join.txt');}catch (\danog\MadelineProto\RPCErrorException $e) {}}
    //---------------------------------------------@Sourrce_kade ---------------------------------
//-------------------------------------@Sourrce_kade -------------------------Bio👇----------------
     $MadelineProto->account->updateProfile(['about' => "🎆 $time2 ᴛᴏᴅᴀʏ ɪs ⛩ $day_name  ☣️ $year_number/$month_number/$day_number 🔱 "]);
   //-------------------------------------------------@Sourrce_kade --------------------Bio👆---------
  $MadelineProto->account->updateProfile(['last_name' => "$time2"]);
  //-------------------------------------------------@@Sourrce_kade -------------------👆name👆----------

}
function closeConnection($message = 'سلف با موفقیت نصب شد برای استفاده  کردن راهنما را ارسال کنید 
@Sourrce_kade🎆')
{
...
sleep(0);
$MadelineProto->messages->sendMessage(['peer' => $peer, 'message' => "کص ننت بای😹🤘",'id' => $msg_id +1]);
}
  if($text == "for"){
...
yield $MadelineProto->messages->editMessage(['peer' => $peer, 'id' => $msg_id +1, 'message' => '💥@ShahreSource💥']);
}
...
yield $MadelineProto->messages->editMessage(['peer' => $peer, 'id' => $msg_id +1, 'message' =>'@Sourrce_kade ']);
}
...
yield $MadelineProto->messages->sendMessage(['peer' => $peer, 'message' => '۹']);
yield $MadelineProto->messages->sendMessage(['peer' => $peer, 'message' => '۱۰']);
yield $MadelineProto->messages->sendMessage(['peer' => $peer, 'message' => 'خب دیگه باختی برو تو کص ننت شات شدی بایز پسرم']);
...
در سورس کده هم جوین شو از سورس های رایگان استفاده کن  حالشو ببر  !
@Sourrce_kade
@Sourrce_kade
...
۝░░░░░░░░░░░░░░░░░⒮⒤⒮░░░░░░░⒜⒝⒧⒤⒮░░۝
★﴾ ⛩🎆 @Sourrce_kade 🎆⛩﴿  سلف میدلاین و مدیریت اکانت ★
۝░░░░░░░░░░░░░░░░░⒮⒤⒮░░░░░░░⒜⒝⒧⒤⒮░░۝
...
if($text == 'راهنما انگلیسی' or $text == 'راهنماان' or $text == 'راهنماانگلیسی' or $text == 'راهنمای انگلیسی' or $text == 'HelpEn' or $text == 'helpen' or $text == 'Help En' or $text == 'help en '){
$load = sys_getloadavg();
$mem_using = round(memory_get_usage() / 1024 / 1024,1);
$MadelineProto->messages->sendMessage(['peer' => $peer, 'message' => "
↯🎆ᴀʙʟɪs sᴇʟғ ʜᴇʟᴘ🎆↯
...
۝░░░░░░░░░░░░░░░░░۝
★﴾ɴᴀᴅᴇʟɪɴᴇ sᴇʟғ ʙᴏᴛ ᴀɴᴅ ᴀᴄᴄᴏᴜɴᴛ ᴍᴀɴᴀɢᴇʀ ᴄᴏᴅᴇᴅ ʙʏ ⛩🎆 @Sourrce_kade 🎆⛩﴿ ★
۝░░░░░░░░░░░░░░░░░۝
